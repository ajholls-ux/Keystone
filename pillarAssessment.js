// ==========================================================================
// Decamark Field Kit -- Pillar Assessment View
//
...
function getPillarPhase(pillarKey) {
  try {
    const v = sessionStorage.getItem("decamark_phase_" + pillarKey);
...
function setPillarPhase(pillarKey, phase) {
  try {
    sessionStorage.setItem("decamark_phase_" + pillarKey, phase);
  } catch (_) {}
}
