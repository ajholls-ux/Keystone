// ==========================================================================
// Decamark Field Kit -- Assessment Report View
//
...
function renderCoverPage(org, review, reportType, cycle) {
  ...
  brand.textContent = "Decamark Field Kit";
  ...
  meta.textContent = `Prepared by ${org.assessorName || "Decamark Assessor"} · ${formatDate(
